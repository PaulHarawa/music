	...
	<div class="col-12 bg-dark">
	 ...
	 <div class="row">
	 	<div class="col-12 bg-dark-all text-white">
	 		<br>
	 		<div class="col-12 align-items-all"><h2>Afro Archive</h2></div>
	 		

	 		<div class="col-12 p-4 text-center"><p><?php 

		            $sql = "SELECT DISTINCT artist FROM songs WHERE genre='Afro'";
		            $result = mysqli_query($conn,$sql);
		            $count = mysqli_num_rows($result);
		            echo"<b>$count</b> Afro artists found";
	 		...
	 		<?php 
	 			...
	 			$sql = "SELECT DISTINCT artist FROM songs WHERE genre='Afro' ORDER BY artist";
						$result = mysqli_query($conn,$sql);
						if(mysqli_num_rows($result)>0){
							while ($row=mysqli_fetch_array($result)) {
								...
								<div class='col-12 p-3 mx-auto'>
		                			<form action='afro.php' method='post' enctype='multipart/form-data' class='text-center'>
...
<!-- ******************************************************************** -->
			...
			<?php
		      ...
		      echo"<script>window.location.href='afro.php';</script>";
				}
			...
			<?php
				...
				if (isset($_SESSION['play'])) {
					...
					<nav class='col-12 navbar navbar-dark bg-white-all-xxxy fixed-bottom' aria-label='Fourth navbar example'>
						...
						<form action='afro.php' method='post' enctype='multipart/form-data' class='mx-auto'>
