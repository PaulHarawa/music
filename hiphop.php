...
<head>
	...
	<title>Music Pablo - HipHop</title>
	...
	<div class="col-12 bg-dark">
	 ...
	 <div class="row">
	 	<div class="col-12 bg-dark-all text-white">
	 		<br>
	 		<div class="col-12 align-items-all"><h2>HipHop Archive</h2></div>
	 		

	 		<div class="col-12 p-4 text-center"><p><?php 

		            $sql = "SELECT  DISTINCT artist FROM songs WHERE genre='HipHop'";
		            $result = mysqli_query($conn,$sql);
		            $count = mysqli_num_rows($result);
		            echo"<b>$count</b> HipHop artists found";
	 		...
	 		<?php 
	 			...
	 			$sql = "SELECT DISTINCT artist FROM songs WHERE genre='HipHop' ORDER BY artist";
						$result = mysqli_query($conn,$sql);
						if(mysqli_num_rows($result)>0){
							while ($row=mysqli_fetch_array($result)) {
								...
								<div class='col-12 p-3 mx-auto'>
		                			<form action='hiphop.php' method='post' enctype='multipart/form-data' class='text-center'>
...
<!-- ******************************************************************** -->
			...
			<?php
		      ...
		      echo"<script>window.location.href='hiphop.php';</script>";
				}
			...
			<?php
				...
				if (isset($_SESSION['play'])) {
					...
					<nav class='col-12 navbar navbar-dark bg-white-all-xxxy fixed-bottom' aria-label='Fourth navbar example'>
						...
						<form action='hiphop.php' method='post' enctype='multipart/form-data' class='mx-auto'>
